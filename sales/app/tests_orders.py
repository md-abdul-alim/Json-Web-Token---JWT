...
class OrdersTest(TestCase):
    ...
    """
    Unauthorized users are not allowed to POST new data. Response code should be 401 (Authenticated)
    """
    ...
    '''
    Authorized users are allowed to POST. And we check that the response is correct. The response code should be 201 (Created)
    '''
    ...
    """
    We should not be able to POST "wrong" data. In this case, the response code should be 400 (Bad request)
    """
    ...
    '''
    Make sure the amount is calculated from price adn quantity. We force amount = 10000, it should be ignored.
    Instead, we should get 5*7 = 35. 
    '''
    ...
    '''
    A scenario with PUT and DELETE methods
    '''
